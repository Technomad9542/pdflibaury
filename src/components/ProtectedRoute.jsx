...
const ProtectedRoute = ({ children }) => {
  ...
  // If no user and not loading, show access denied message
  return (
    <div className="min-h-screen bg-gradient-to-br from-dark-400 via-dark-300 to-dark-200 flex items-center justify-center">
      <div className="text-center max-w-md px-4">
        ...
        <p className="text-gray-300 mb-6">
          This page is only accessible to authenticated users. Please log in with your Google account to continue.
        </p>
        <button
          onClick={() => navigate('/')}
